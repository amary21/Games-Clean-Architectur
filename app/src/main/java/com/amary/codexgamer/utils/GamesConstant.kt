...
object GamesConstant {
    ...
    val adapterFavoriteGamesCallback = object : DiffUtil.ItemCallback<GamesFavorite>(){
        override fun areItemsTheSame(oldItem: GamesFavorite, newItem: GamesFavorite)= oldItem.favorite == newItem.favorite
        override fun areContentsTheSame(oldItem: GamesFavorite, newItem: GamesFavorite) = oldItem == newItem
    }
}